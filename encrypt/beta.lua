			...
			function group.new_category(title_text, title_alignment)
				...
				function category.new_toggle(...)
					...
					local toggle, default = { 
						...
						yield = false,
						callback = function()
							warn(string.format('[Ã¢Ââ€”] Toggle #%d > no callback set.', category.toggle_count))
						end,
					}
				...
				function category.new_button(...)
					...
					local text_button, default = {}, {
						text = 'button',
						callback = function()
							warn(string.format('[Ã¢Ââ€”] Button #%d > no callback set.', category.button_count))
						end,
					}
				...
				function category.new_textbox(...)
					...
					local text_box, default = {}, {
						...
						placeholder_text = '...',
						callback = function()
							warn(string.format('[Ã¢Ââ€”] Textbox #%d > no callback set.', category.textbox_count))
						end,
					}
				...
				function category.new_keybind(...)
					...
					local keybind, default = {}, {
						...
						keybind = '...',
						callback = function()
							warn(string.format('[Ã¢Ââ€”] Keybind #%d > no callback set.', category.keybind_count))
						end,
					}
				...
				function category.new_slider(...)
					...
					local slider, default = {}, {
						...
						callback = function()
							warn(string.format('[Ã¢Ââ€”] Slider #%d > no callback set.', category.slider_count))
						end,
					}
				...
				function category.new_dropdown(...)
					...
					local dropdown, default = {}, {
						...
						callback = function()
							warn(string.format('[Ã¢Ââ€”] Dropdown #%d > no callback set.', category.dropdown_count))
						end,
					}
				...
				function category.new_colorpicker(...)
					...
					local color_picker, default = {}, {
						...
						callback = function() 
							warn(string.format('[Ã¢Ââ€”] Color Picker #%d > no callback set.', category.colorpicker_count))
						end,
					}
