	...
	function Window:NewTab(Name, Icon)
		...
		function Tab:NewSection(Name, Side, Icon)
			...
			function Section:NewToggle(...)
				...
				local Circle = blitz.create("ImageLabel", { Parent = ElementButton, BorderSizePixel = 0, BackgroundTransparency = 0.75, BackgroundColor3 = Color3.fromRGB(255, 255, 255), AnchorPoint = Vector2.new(1, 0.5), Size = UDim2.new(1, -6, 1, -6), BorderColor3 = Color3.fromRGB(0, 0, 0), Position = UDim2.new(1, 0, 0.5, 0),})
